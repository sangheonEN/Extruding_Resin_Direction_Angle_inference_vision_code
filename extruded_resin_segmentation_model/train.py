...
if __name__ == "__main__":
    ...
    parser.add_argument("--backbone", type=str, default='resnet', choices=['resnet', 'moblienet'])
    ...
    parser.add_argument("--loss_func", type=str, default='LASD', choices=['Hard_Easy_Loss', 'LASD', 'ce', 'ce_effective', 'focal', 'focal_effective', 'focal_effective_square_sqrt'])
    ...
    trainer = Trainer(train_dataloader, valid_dataloader, opts, summary, experiment_dataloader)
